...
//--------------------------------------------------------------------------------------------------------
    ...
    for(Integer i = 0;  i<6; i++){
        ...
        roboczyRadioButton.addItemListener(new ItemListener() {//....ORAZ NADAWANIE IM LOGIKI DZIALANIA
            @Override
...
//-------------------------------------------------------------------------------------------------------- 
//-------------------------------------------------------------------------------------------------------- 
    poleTekstoweDoZaklocenia.addActionListener(new ActionListener() {//DO TEGO POLA PRZYPISANA JEST GŁÓWNA LOGIKA APLIKACJI
        @Override
        public void actionPerformed(ActionEvent ae) {
