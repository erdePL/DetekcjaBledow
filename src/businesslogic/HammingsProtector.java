...
public class HammingsProtector extends ParityProtectorPositive {
    public static String addHammingsControlToBinarySequence(String inWord){
        ...
        for(int i = 1; i<hammingProtectedWord.length(); i*=2){    
            ...
            String parityBitValue = ParityProtectorPositive.calculateParityBitForBinaryString(bitsToCheck);
...
//---------------------------------------------------------------------------------------------------   
    public static boolean isHammingProtectedWordCorrect(String inWord){
        int errorsCount = 0;
        errorsCount = countBitErrors(inWord);
        if(errorsCount == 0)
            return true;
        else
            return false;
...
//---------------------------------------------------------------------------------------------------     
    public static int countBitErrors(String inWord){
        int errorsCount = getWrongParityBitsPositions(inWord).length();
        return errorsCount;
    }
//---------------------------------------------------------------------------------------------------     
    public static String getWrongParityBitsPositions(String inWord){
...
//--------------------------------------------------------------------------------------------------- 
   public static boolean isOneBitError(String inWord, String errorsPositions){
        if(errorsPositions.length()>1){
            return false;
        }else
            return true;
    }
