...
public class ParityControllerPositive {
//---------------------------------------------------------------------------------------------------    
...
//--------------------------------------------------------------------------------------------------- 
    public static String convertStringToBinaryString(String stringToConvert){
        String binaryString = "";
        for(char element : stringToConvert.toCharArray()){
           binaryString += convertCharToBinaryString(element) ;
        }
        return binaryString;
    }
//--------------------------------------------------------------------------------------------------- 
    public static String convertCharToBinaryString(char charToConvert){
